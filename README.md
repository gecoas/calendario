...
La app lee el calendario mediante una URL de Google Calendar. Acepta tanto una URL iCal/ICS como una URL de Google Calendar con parametro `cid`, por ejemplo `https://calendar.google.com/calendar/u/0?cid=...`.
